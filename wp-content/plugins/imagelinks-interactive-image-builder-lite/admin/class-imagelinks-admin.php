...
class ImageLinks_Admin {
	...
	function view_edit($views) {
		$views['import'] = '<div class="updated"><p>Note: This is the lite version of the ImageLinks WordPress plugin. You can create and use only one item.<br/><a href="https://codecanyon.net/item/imagelinks-interactive-image-builder-for-wordpress/16654231?ref=avirtum" target="_blank">Click here to purchase pro version</a></p></div>';
		return $views;
	}
	...
	public function save_post($post_id) {
		...
		if ( isset( $_REQUEST['imgl-meta-ui-cfg'] ) ) { 
			...
			$meta_value = htmlentities($_REQUEST['imgl-meta-ui-cfg'],ENT_QUOTES);
		...
		if ( isset( $_REQUEST['imgl-meta-imagelinks-cfg'] ) ) {
			...
			$meta_value = htmlentities($_REQUEST['imgl-meta-imagelinks-cfg'],ENT_QUOTES);
