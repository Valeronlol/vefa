...
$thumb = get_the_post_thumbnail_url(39) ? get_the_post_thumbnail_url(39) : '../wp-content/themes/valeron/frontend/dist/img/default_page_preview.jpg';
...
<?php if ($the_query->have_posts()) : ?>
	...
	<div class="page-preview" style="background-image: url('<?php echo $thumb; ?>')">
		<div class="container">
			<h1><?php echo get_the_title(39); ?></h1>
		</div>
	</div>
		...
		<div class="container">
			<div class="row">
				<?php while ($the_query-> have_posts()) : $the_query->the_post(); ?>
					...
					if ( !$thumbnail ) $thumbnail = site_url() . '/wp-content/themes/valeron/frontend/dist/img/default_page_item.jpg';
					?>
