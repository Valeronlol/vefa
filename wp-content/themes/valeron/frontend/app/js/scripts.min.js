...
slidesToScroll:1,dots:!0,arrows:!1,autoplay:!0,autoplaySpeed:5e3,responsive:[{breakpoint:768,settings:{slidesToShow:2,slidesToScroll:2}},{breakpoint:480,settings:{slidesToShow:1,slidesToScroll:1}}]}),$("header .search").on("click",function(){$(this).toggleClass("active"),$(this).find(".text").focus()}),$("#burger").on("click",function(){var e=$(".nav .menu");$(this).hasClass("active")?($(this).removeClass("active"),e.css("display","")):($(this).addClass("active"),e.css("display","block"))}),$(".burger_close_btn").on("click",function(){$("#burger").removeClass("active"),$(".nav .menu").css("display","")})});